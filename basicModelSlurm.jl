...
function main(cb,simulationNumber::Int64,P::InfluenzaParameters)
    ...
    Incidence = zeros(Int64,15,P.sim_time)
    ...
    Proportion = Calculating_Proportion(latent_ctr,Incidence,P.sim_time)
    ...
    return latent_ctr,symp_ctr,asymp_ctr,numb_first_inf,numb_symp_inf,numb_asymp_inf,Infection_Matrix,Fail_Contact_Matrix,Contact_Matrix_General,Number_in_age_group,NumberFailsAge,InfOrNot,Proportion
